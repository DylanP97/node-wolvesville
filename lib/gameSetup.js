...
exports.editGame = (game, type, actionObj, message) => {
  switch (type) {
    ...
    case "addVote":
      game.playersList = voteAgainst(actionObj.selectedPlayerId, game.playersList, actionObj.nbr);
      break;

    case "addWolfVote":
      game.playersList = wolfVoteAgainst(actionObj.selectedPlayerId, game.playersList, actionObj.nbr);
      break;
