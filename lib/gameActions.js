...
exports.handleVote = (playersList, messagesHistory, winningTeam) => {
  ...
  playersList = initializeVotes(playersList)
...
exports.handleWolvesVote = (playersList, messagesHistory, winningTeam) => {
  const mostVotedAgainstPlayer = findPlayerWithMostWolvesVotes(playersList);
  if (!mostVotedAgainstPlayer) {
  ...
  playersList = initializeWolvesVotes(playersList);
...
exports.murder = (newPlayersList, newMessagesHistory, action) => {
  ...
  // need to add healed and inlove cases

  return { newPlayersList, newMessagesHistory }
}
